...
describe("routes : comments", () => {
        ...
        Topic.create(
          {
            ...
            description:
              "A compilation of reports from recent visits to the star",
            posts: [
              {
  ...
  describe("non-owner member performing CRUD actions on comment", () => {
    beforeEach(done => {
      request.get(
        {
          url: "http://localhost:3000/auth/fake",
  ...
  // Admin User
  describe("admin user performing CRUD actions on Comment", () => {
    beforeEach(done => {
      request.get(
        {
          url: "http://localhost:3000/auth/fake",
